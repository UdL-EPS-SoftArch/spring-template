Feature: Create a Column of the mapping
  ...
  Background:
    ...
    Scenario: Create a column of the mapping
      When I create a new column with title "weight" and data type "xsd:integer" for the mapping "CEP-2021-S1-WEIGHT.csv"
      Then It has been created a new column with title "weight" and data type "xsd:integer" for the mapping "CEP-2021-S1-WEIGHT.csv"
